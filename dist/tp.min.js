...
EXPANDED:"expanded",FULLSCREEN:"fullscreen"};static DEFAULT_DISPLAY_MODE=GPTimelapsePlayer_.DISPLAY_MODE.NORMAL;static FV2_DATE=1681366233E3;constructor({image:{data:a,background:b,auth:c,meta:{author:g,title:f,date:k}},container:d,mainContainer:e},h=GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE,l=!1){super();GPTimelapsePlayer_.players.add(this);this.density=GPTimelapsePlayer_.DENSITY;this.width=GPTimelapsePlayer_.WIDTH;this.height=GPTimelapsePlayer_.HEIGHT;this.originalData=a.slice();const [m,n]=this.handleDelimiters(a,b);this.data=m;this.background=n;this.auth=c;this.author=g;this.title=f;this.date=new Date(k);this.fi=k&&this.date.getTime()>GPTimelapsePlayer_.FV2_DATE?5:4;this.container=d;this.container.isPlayerRendered=!0;this.mainContainer=e;this.defaultDisplayMode=h;this.defaultDisplayModeDensity=this.getModeDensity(h);this.cache;this.canvas;this.ctx;this.isPlaying=!1;this.currentSpeed=JSON.parse(window.localStorage.getItem("gp-timelapse-player-speed"))||GPTimelapsePlayer_.SPEED;this.speed=GPTimelapsePlayer_.SPEEDS[this.currentSpeed];this.sPos=
this.pos=0;this.lastContainerDimension={width:0,height:0};this.isContextLayoutShown=this.isFullscreen=this.isExpanded=!1;this.isContextMenuDisabled=l;this.progressBarPointerMoveHandler=this.progressBarPointerMoveHandler.bind(this);this.resizeHandler=this.resizeHandler.bind(this);this.toggleFullscreen=this.toggleFullscreen.bind(this);this.playPause=this.playPause.bind(this);this.drawing=this.drawing.bind(this);this.expand=this.expand.bind(this);this.terminate=this.terminate.bind(this);this.toggleContextLayout=
...
a.at(-1)[1]-GPTimelapsePlayer_.ORIGINAL_HEIGHT-GPTimelapsePlayer_.M_STROKE_OFFSET?!1:!0}render(){this.player=document.createElement("div");this.player.className="timelapse-player_";this.player.addEventListener("click",f=>{f.stopPropagation()});this.player.addEventListener("pointerdown",f=>{f.stopPropagation()});this.player.addEventListener("pointerup",f=>{f.stopPropagation()});this.player.addEventListener("mouseup",f=>{f.stopPropagation()});this.player.addEventListener("mousedown",f=>{f.preventDefault();
f.stopPropagation();1===f.button&&(this.isFullscreen?this.toggleFullscreen():this.expand())},!0);this.player.addEventListener("contextmenu",f=>{f.stopPropagation();f.preventDefault();this.toggleContextLayout()});this.player.addEventListener("fullscreenchange",f=>{this.isFullscreen=!!document.fullscreenElement;this.player.classList.toggle("fullscreen_",this.isFullscreen);this.mainContainer.classList.toggle("gp-tp-fullscreen_",this.isFullscreen);this.resizeHandler()});this.bgCanvas=document.createElement("canvas");
