...
background:b,canvasType:c,auth:e,meta:{author:d,title:f,date:g}},container:h,mainContainer:k},l=GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE,p=!1){super();GPTimelapsePlayer_.players.add(this);this.canvasType=c;this.canvasTypeName=GPUtils_.getCanvasTypeName(c);const [n,m]=GPUtils_.getCanvasDimensions(c);this.density=GPTimelapsePlayer_.CANVAS_DENSITY;this.originalWidth=n;this.originalHeight=m;this.width=this.originalWidth*this.density;this.height=this.originalHeight*this.density;this.originalData=a.slice();
const [q,r,t]=this.handleDelimiters(a,b);this.data=q;this.background=r;this.auth=e;this.author=d;this.title=f;this.date=new Date(g);this.eraserAlpha=!t;this.fi=g&&this.date.getTime()>GPTimelapsePlayer_.FV2_DATE?5:4;this.container=h;this.container.isPlayerRendered=!0;this.mainContainer=k;this.defaultDisplayMode=l;this.defaultDisplayModeDensity=this.getModeDensity(l);this.cache;this.canvas;this.ctx;this.isPlaying=!1;this.currentSpeed=JSON.parse(localStorage.getItem("gp-timelapse-player-speed"))||GPTimelapsePlayer_.SPEED;
this.speed=GPTimelapsePlayer_.SPEEDS[this.currentSpeed];this.sPos=this.pos=0;this.lastContainerDimension={width:0,height:0};this.isContextLayoutShown=this.expandStateBeforeFullscreen=this.isFullscreen=this.isExpanded=!1;this.isContextMenuDisabled=p;this.isStandalone=!GPTimelapsePlayer_.GARTICPHONE_HOSTNAME_PATTERN.test(location.hostname);GPUtils_.bindMethods([this.progressBarPointerMoveHandler,this.resizeHandler,this.toggleFullscreen,this.playPause,this.drawing,this.expand,this.terminate,this.toggleContextLayout,
...
a.at(-1)[1]-this.originalHeight-GPTimelapsePlayer_.M_STROKE_OFFSET?!1:!0}render(){this.player=document.createElement("div");this.player.className="timelapse-player_";this.player.dataset.canvasType=this.canvasTypeName;this.player.addEventListener("click",d=>{d.stopPropagation()});this.player.addEventListener("pointerdown",d=>{d.stopPropagation()});this.player.addEventListener("pointerup",d=>{d.stopPropagation()});this.player.addEventListener("mouseup",d=>{d.stopPropagation()});this.player.addEventListener("mousedown",
d=>{d.preventDefault();d.stopPropagation();1===d.button&&(this.isFullscreen?this.toggleFullscreen():this.expand())},!0);this.player.addEventListener("contextmenu",d=>{d.stopPropagation();d.preventDefault();this.toggleContextLayout()});this.player.addEventListener("fullscreenchange",d=>{this.isFullscreen=!!document.fullscreenElement;this.player.classList.toggle("fullscreen_",this.isFullscreen);this.mainContainer.classList.toggle("gp-tp-fullscreen_",this.isFullscreen);this.isStandalone&&!this.isFullscreen?
...
this.contextLayout=document.createElement("div");this.contextLayout.className="context-layout_";this.contextLayout.addEventListener("click",this.toggleContextLayout);a=document.createElement("div");a.className="save-img-data-btn_ btn_";a.title="\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0438\u0441\u0445\u043e\u0434\u043d\u0438\u043a";a.addEventListener("click",d=>{d.stopPropagation();this.saveImageData()});this.contextLayout.appendChild(a);a=document.createElement("div");a.className=
"save-img-btn_ btn_";a.title="\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0438\u0437\u043e\u0431\u0440\u0430\u0436\u0435\u043d\u0438\u0435";a.addEventListener("click",d=>{d.stopPropagation();this.saveImage()});this.contextLayout.appendChild(a);this.player.appendChild(this.contextLayout);this.container.firstElementChild.before(this.player);this.resizeHandler()}toggleContextLayout(){this.isContextMenuDisabled||(this.pause(),this.isContextLayoutShown=!this.isContextLayoutShown,this.player.classList.toggle("context-menu_",
