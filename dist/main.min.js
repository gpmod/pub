...
Math.max(b,.1)}),localStorage.setItem("gp_painter",JSON.stringify(a)))},()=>{const a=JSON.parse(localStorage.getItem("gp_painter_bindings"));a&&localStorage.setItem("gp_painter_bindings",JSON.stringify(this.insertShortcuts({perfectShapes:[["KeyQ"]]},a)))}]]];static compareVersion(a,b){const c=Math.max(a.length,b.length);for(let d=0;d<c;d++){const e=a[d]??0,f=b[d]??0;if(e>f)return 1;if(e<f)return-1}return 0}static migrate(a){a=a.split(".");let b=this.TASKS.length;for(let c=this.TASKS.length-1;0<=c;c--)if(-1===
this.compareVersion(a,this.TASKS[c][0]))b=c;else break;this.TASKS.slice(b).forEach(([c,d])=>{try{d.forEach(e=>{e()}),console.log(`gpmod: migrating to v${c.join(".")}`)}catch(e){console.error(`gpmod: migration error to v${c.join(".")} |`,e)}})}static editStorage({insert:a,rename:b,remove:c}={}){const d={};a?.forEach(([e,f,g])=>{d[e]??(d[e]=[]);d[e].push([GPMigration_.INSERT,f,g])});b?.forEach(([e,f,g])=>{d[e]??(d[e]=[]);d[e].push([GPMigration_.RENAME,f,g])});c?.forEach(([e,f])=>{d[e]??(d[e]=[]);d[e].push([GPMigration_.REMOVE,
f])});for(let e in d){let f;try{f=JSON.parse(localStorage.getItem(e))??{}}catch{continue}d[e].forEach(([g,...k])=>{switch(g){case GPMigration_.INSERT:const [h,l]=k;f[h]=l;break;case GPMigration_.RENAME:const [m,p]=k;m in f&&(f[p]=f[m],delete f[m]);break;case GPMigration_.REMOVE:[g]=k,delete f[g]}});localStorage.setItem(e,JSON.stringify(f))}}static init(a){let b=this.latestVersion();b&&b!==a?this.migrate(b):this.painter105();localStorage.setItem("gp_latest-version",a)}static latestVersion(){return localStorage.getItem("gp_latest-version")||
localStorage.getItem("gp_update")||JSON.parse(localStorage.getItem("gp_about"))?.lastNotifiedVersion}static painter105(){const a=JSON.parse(localStorage.getItem("gp_painter"));a?.defaultColor&&!Array.isArray(a.defaultColor)&&localStorage.setItem("gp_painter",JSON.stringify(Object.assign(a,{defaultColor:["#000000","#ffffff"]})))}static insertShortcuts(a,b){const c=new Set;for(const d of Object.values(b))d.forEach(e=>{c.add([...e].sort().join("+"))});for(const [d,e]of Object.entries(a))b[d]||(b[d]=
[]),e.forEach(f=>{const g=[...f].sort().join("+");c.has(g)||(b[d].push(f),c.add(g))});return b}}window.GPMigration_=GPMigration_;(()=>{function a(d,e,f){c.ws=d;c.mm=new GPModulesManager_(e,f);c.sm=c.mm.getSettingsManager();c.app=b;c.mm.setModules([{id:0,name:"GPProxy_",required:!0,hidden:!0},{id:6,name:"GPAbout_",required:!0,hidden:!0},{id:9,name:"GPActivation_",required:!0,hidden:!0},{id:10,name:"GPAvatars_",required:!0,hiddenSettings:!0},{id:2,name:"GPPlayersManager_"},{id:8,name:"GPReference_"},{id:4,name:"GPPainter_"}],this,c)}const b={author:"liliezzzz",name:"gp-mod",tag:"gpmod",version:"10.6.3",betaFlag:!1,changelogURL:"https://discord.com/channels/929715202600095775/953145081471324270/1494723661045825547",
...
_3:{text:"Opacity"},minOpacity:{type:"slider",args:{min:this.MIN_OPACITY,max:1,step:.01},description:"\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u044c \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"},opacitySensitivity:{type:"slider",args:{min:.1,max:3,step:.1},description:"\u0427\u0443\u0432\u0441\u0442\u0432\u0438\u0442\u0435\u043b\u044c\u043d\u043e\u0441\u0442\u044c \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"},
...
this.DIRECTION.UP_LEFT]},description:"\u041d\u0430\u043f\u0440\u0430\u0432\u043b\u0435\u043d\u0438\u0435 \u043f\u043e\u0432\u044b\u0448\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u043e\u0439 \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"},opacityStep:{type:"slider",args:{min:.01,max:10,step:.01},description:"\u0428\u0430\u0433 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448"},
customOpacity:{type:"list-numbers",args:{items:[{min:this.MIN_OPACITY,max:1,step:.01},{min:this.MIN_OPACITY,max:1,step:.01},{min:this.MIN_OPACITY,max:1,step:.01},{min:this.MIN_OPACITY,max:1,step:.01},{min:this.MIN_OPACITY,max:1,step:.01}]},description:"\u041f\u0440\u043e\u0438\u0437\u0432\u043e\u043b\u044c\u043d\u044b\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u043d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u0438 \u043a\u0438\u0441\u0442\u0438 \u0434\u043b\u044f \u0431\u044b\u0441\u0442\u0440\u043e\u0433\u043e \u0432\u044b\u0431\u043e\u0440\u0430 \u0441 \u043f\u043e\u043c\u043e\u0449\u044c\u044e \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448"},
...
alias:"pa",dependencies:["GPDrawInterface_","GPColorUtils_","GPColorPicker_"],settings:{storage:"gp_painter",defaultSettings:this.DEFAULT_SETTINGS,ui:this.SETTINGS_UI},useCSS:!0};constructor(a){super();return;this.prx=a.prx;this.sm=a.sm;this.timer=a.tmr;this.reference=a.ref;this.ac=a.ac;this.abt=a.abt;this.s=a.sm.setSettings(this,this.updateSettings);this.tools={dropper:{activator:{pointer:{0:{pointerMove:this.dropperPointerMove}},keyDown:this.dropperKeyDown,end:this.dropperEnd}},thickness:{activator:{pointer:{0:{pointerMove:this.thicknessPointerMove,
...
this.s.defaultThickness));a=Math.max(this.s.minOpacity,this.s.defaultOpacity);this.opacity=1===a?a:String(a);this.tool=GPPainter_.DEFAULT_TOOL;this.isNote=!1;this.searchTimer=null;this.strokeId=GPPainter_.FIRST_STROKE_ID;this.strokeOptions=[];this.strokeCoords=[];this.history=[];this.undos=[];this.lastDrawData=this.backgroundData=null;this.gridType=0;this.lastDelimiterIndex=-1;this.isSigned=!1;this.mStrokeId=null;this.mStrokeOrigin=this.getRandomInt(GPPainter_.M_STROKE_RANGE);this.isSubscribed=!1;
this.lastClientY=this.lastClientX=0;this.isDrawing=this.isPerfectShapes=this.isToolCentering=this.isEraser=this.isGrayscale=this.isVerticalMirror=this.isMirror=!1;this.centering\u0421oords=[];this.isSymmetryGuidesMoved=this.isSymmetryGuidesMoving=this.isSymmetryGuidesAdjustable=this.isSymmetryKeyPressed=this.isSymmetryEnabled=!1;this.symmetryStrokesOptions=[];this.symmetryCoords=[];this.symmetryStrokesGroups={};this.symmetryGuideAngle=this.getSymmetryModeGuidesAngle(this.s.symmetryMode);this.isDisabled=
!1;this.isTerminated=!0;this.localization=this.prx.getLocalization("draw");this.isReadyWarningShown=!1;this.lineSmoothingCounter=1;this.background;this.backgroundCtx;this.lastDraw;this.lastDrawCtx;this.canvas;this.canvasCtx;this.stroke;this.strokeCtx;this.pointer;this.pointerCtx;this.colorPicker;this.colorPickerWidth=GPPainter_.COLOR_PICKER_WIDTH;this.colorPickerHeight=GPPainter_.COLOR_PICKER_HEIGHT;this.colorPickerHuePos=GPPainter_.COLOR_PICKER_HUE_POSITION;this.setFillAlgorithm(this.s.fillAlgorithm);
...
this.resizeWindowHandler),this.clearPointer(),this.clearStroke(),this.clearCanvas(),this.clearBackground(),this.background.classList.add("hidden"),this.lastDraw.classList.add("hidden"),this.colorPicker.hide(),this.iface.terminate(),this.reference?.terminate(),this.container.remove(),this.isTerminated=!0)}resetTurnSettings(){if(this.container){this.color=this.s.defaultColor[0];this.color2=this.s.defaultColor[1];this.thickness=Math.max(this.s.minThickness,Math.min(this.s.maxThickness,this.s.defaultThickness));
var a=Math.max(this.s.minOpacity,this.s.defaultOpacity);this.opacity=1===a?a:String(a);this.tool=GPPainter_.DEFAULT_TOOL;this.isSymmetryGuidesMoved=this.isSymmetryGuidesMoving=this.isSymmetryGuidesAdjustable=this.isSymmetryKeyPressed=this.isSymmetryEnabled=!1;this.symmetryStrokesOptions=[];this.symmetryCoords=[];this.symmetryStrokesGroups={};!this.isSubscribed&&!this.prx.isSoloGame()&&1<this.s.symmetryMode&&(this.s.symmetryMode=GPPainter_.DEFAULT_SYMMETRY_MODE,this.drawSymmetryGuides());this.symmetryGuides.classList.add("hidden");
...
1);return Math.max(a+1,GPPainter_.FIRST_STROKE_ID)}middleButtonDown(a){1!==a.button||this.hasActiveTools()||(this.runPointerTool("hand",a,0),a.stopPropagation(),a.stopImmediatePropagation())}rightButtonDown(a){2===a.button&&document.addEventListener("contextmenu",this.preventDefault,{once:!0})}strokeDown(a){this.prx.isConnected()||this.abt?.showDisconnectionNotice();this.isDrawing&&this.strokeUp(a);if(!this.hasActiveTools()){var b=2===a.button?this.color2:this.color,c=this.getCanvasCoords(a);this.strokeOptions=
this.getStrokeOptions(this.tool,b);this.strokeCoords=[c];this.isCenteringActivated=this.shouldCenteringBeActivated(this.tool);this.centering\u0421oords=[c.slice()];this.isSymmetryEnabled&&this.convertToSymmetryCoords(c).forEach((d,e)=>{const f=this.strokeOptions.slice();f[1]=this.strokeId++;this.symmetryStrokesOptions[e]=f;this.symmetryCoords[e]=[d];this.centering\u0421oords[e+1]=d.slice()});this.lineSmoothingCounter=1;this.tool===GPPainter_.TOOL.FILL?(this.updateStrokeCoords(this.strokeCoords,this.getUnscaledCanvasCoords(a),
void 0,b),a=this.buildStrokeData(this.strokeOptions,this.strokeCoords),this.dispatchEvent(new CustomEvent("stroke_started",{detail:{data:a}})),this.dispatchEvent(new CustomEvent("stroke",{detail:{data:a}}))):(a.currentTarget.setPointerCapture(a.pointerId),a.currentTarget.addEventListener("pointermove",this.strokeMove),a.currentTarget.addEventListener("pointerup",this.strokeUp,{once:!0}),a=[...this.strokeOptions,...this.strokeCoords],b=this.buildSymmetryStrokesData(!0),this.drawFunction(this.strokeCtx,
...
this.strokeMove);this.strokeMove.cancel?.()}strokeProcess(){let a;this.isSymmetryEnabled&&(a=[],this.symmetryCoords.forEach((b,c)=>{a.push(this.buildStrokeData(this.symmetryStrokesOptions[c],b))}));this.dispatchEvent(new CustomEvent("stroke_process",{detail:{data:[...this.strokeOptions,...this.strokeCoords],symmetryStrokesData:a}}));!this.isSymmetryEnabled&&this.isStreamingTool(this.tool)&&(clearTimeout(this.strokeTimer),this.strokeTimer=setTimeout(this.strokeProcess,1E3))}updateSymmetryStrokeCoords(a){a.forEach((b,
c)=>{this.updateStrokeCoords(this.symmetryCoords[c],b,c+1)})}snapCoordinates(a,b){let [c,d]=a,[e,f]=b;a=c-e;b=d-f;if(this.tool===GPPainter_.TOOL.LINE){if(Math.abs(a)>1.5*Math.abs(b))return[c,f];if(Math.abs(b)>1.5*Math.abs(a))return[e,d];var g=Math.max(Math.abs(a),Math.abs(b));return[e+(0<a?g:-g),f+(0<b?g:-g)]}g=Math.max(Math.abs(a),Math.abs(b));return[e+(0<a?g:-g),f+(0<b?g:-g)]}updateStrokeCoords(a,b,c=0,d=this.color){switch(this.tool){case GPPainter_.TOOL.BRUSH:case GPPainter_.TOOL.ERASER:case GPPainter_.TOOL.NOTE:this.s.lineSmoothingLevel&&
(this.tool!==GPPainter_.TOOL.ERASER||this.s.eraserLineSmoothing)&&this.lineSmoothingCounter%(this.s.lineSmoothingLevel+1)||a.push(b);break;case GPPainter_.TOOL.LINE:case GPPainter_.TOOL.RECTANGLE:case GPPainter_.TOOL.CIRCLE:case GPPainter_.TOOL.RECTANGLE_FILLED:case GPPainter_.TOOL.CIRCLE_FILLED:d=[a[0],b];a.length=0;a.push(...d);if(this.isCenteringActivated){const [e,f]=this.centering\u0421oords[c];this.isPerfectShapes?(a[1]=this.snapCoordinates(b,[e,f]),a[0][0]=e-(a[1][0]-e),a[0][1]=f-(a[1][1]-
f)):(a[0][0]=e-(b[0]-e),a[0][1]=f-(b[1]-f))}else this.isPerfectShapes&&(a[1]=this.snapCoordinates(b,a[0]));break;case GPPainter_.TOOL.FILL:a.length=0,a.push(...this.getFillData(b[0],b[1],d))}}getStrokeOptions(a=this.tool,b=this.color,c=this.thickness){switch(a){case GPPainter_.TOOL.BRUSH:case GPPainter_.TOOL.LINE:case GPPainter_.TOOL.RECTANGLE:case GPPainter_.TOOL.CIRCLE:case GPPainter_.TOOL.RECTANGLE_FILLED:case GPPainter_.TOOL.CIRCLE_FILLED:return[a,this.strokeId++,[b,c,this.opacity]];case GPPainter_.TOOL.ERASER:return[a,
this.strokeId++,!this.s.doubleEraserThickness||this.isEraser&&this.s.disableDoubleEraserThicknessOnShortcut?c:Math.min(2*c,GPPainter_.MAX_THICKNESS)];case GPPainter_.TOOL.FILL:return[a,this.strokeId++,[b,this.opacity]];case GPPainter_.TOOL.NOTE:return[a,this.strokeId++,null]}}buildStrokeData(a,b,c=!1){return[...a,...(c||!this.isMirror&&!this.isVerticalMirror||a[0]===GPPainter_.TOOL.FILL?b:this.mirrorStrokeCoords(b,this.isMirror,this.isVerticalMirror))]}lockPointer(){this.pointerLock=!0}unlockPointer(){this.pointerLock=
!1}updatePointer(a){this.pointerLock||this.renderPointer(...this.getPointerCoords(a))}getPointerCoords(a){const b=this.getScale(),c=this.pointer.getBoundingClientRect();let d;a?(d=a.clientX,a=a.clientY):(d=this.lastClientX,a=this.lastClientY);return[(d-c.left)*this.density/b*GPPainter_.CANVAS_DENSITY,(a-c.top)*this.density/b*GPPainter_.CANVAS_DENSITY]}renderPointer(a,b,c,d=this.thickness,e,f){this.clearPointer();d=this.activator===GPPainter_.ACTIVATOR.ZOOM?1:!e&&GPPainter_.TOOLS_THICKNESSES[this.tool]||
d;this.tool!==GPPainter_.TOOL.ERASER||!this.s.doubleEraserThickness||this.isEraser&&this.s.disableDoubleEraserThicknessOnShortcut||(d=Math.min(2*d,GPPainter_.MAX_THICKNESS));d*=this.zoomer.getScale();c=this.activeTool===GPPainter_.ACTIVATOR.THICKNESS||this.activator!==GPPainter_.ACTIVATOR.OPACITY&&this.activator!==GPPainter_.ACTIVATOR.BRIGHTNESS?c:this.opacity;e=this.pointerCtx;var g=Math.min(Math.max(this.zoomer.getScale(),1),2)*GPPainter_.CANVAS_DENSITY;e.lineWidth=g;var k=d/2*this.density;e.beginPath();
e.arc(a,b,k,0,2*Math.PI);c&&(e.fillStyle=`rgba(${GPColorUtils_.hexToRgb(this.color).join(",")},${c}`,e.fill());e.strokeStyle=GPPainter_.POINTER_COLOR;e.stroke();e.beginPath();e.arc(a,b,k+g,0,2*Math.PI);e.strokeStyle=GPPainter_.POINTER_OUTLINE_COLOR;e.globalAlpha=.5;e.stroke();e.globalAlpha=this.s.pointerOpacity;if(2>d){var h=GPPainter_.CANVAS_DENSITY;d=3*Math.max(d,2)*h;g=GPPainter_.POINTER_CROSSHAIR_LINE_LENGTH*h;k=1*h;var l=1*h;h=k+2*l;const m=d-l;l=g+2*l;e.beginPath();e.moveTo(a,b-m);e.lineTo(a,
b-m-l);e.moveTo(a+m,b);e.lineTo(a+m+l,b);e.moveTo(a,b+m);e.lineTo(a,b+m+l);e.moveTo(a-m,b);e.lineTo(a-m-l,b);e.globalAlpha=.5;e.strokeStyle=GPPainter_.POINTER_OUTLINE_COLOR;e.lineWidth=h;e.stroke();e.beginPath();e.moveTo(a,b-d);e.lineTo(a,b-d-g);e.moveTo(a+d,b);e.lineTo(a+d+g,b);e.moveTo(a,b+d);e.lineTo(a,b+d+g);e.moveTo(a-d,b);e.lineTo(a-d-g,b);e.globalAlpha=this.s.pointerOpacity;e.strokeStyle=GPPainter_.POINTER_COLOR;e.lineWidth=k;e.stroke();e.globalAlpha=this.s.pointerOpacity}if(f){const [m,p]=
f;e.beginPath();e.arc(m,p,GPPainter_.POINTER_DOT_THICKNESS/2*this.density,0,2*Math.PI);c&&(e.fillStyle=`rgba(${GPColorUtils_.hexToRgb(this.color).join(",")},${c}`,e.fill());e.strokeStyle=GPPainter_.POINTER_COLOR;e.stroke();e.beginPath();e.arc(m,p,(GPPainter_.POINTER_DOT_THICKNESS/2+1)*this.density,0,2*Math.PI);e.strokeStyle=GPPainter_.POINTER_OUTLINE_COLOR;e.globalAlpha=this.s.pointerOutlineOpacity;e.stroke();e.globalAlpha=this.s.pointerOpacity}}setTool(a){this.tool=a;a=a===GPPainter_.TOOL.NOTE;const b=
a!==this.isNote;this.isNote=a;b&&(this.redrawBackground(),this.redrawLastDraw(),this.redrawCanvas())}getColor(){return this.color}getColor2(){return this.color2}setColor(a){this.colorPicker.setColor(a);this.dispatchEvent(new CustomEvent("color",{detail:{color:a}}))}setColor2(a){this.dispatchEvent(new CustomEvent("color2",{detail:{color:a}}))}setOpacity(a){this.opacity=String(a);this.iface.updateOpacity(a)}setThickness(a){this.thickness=a}toggleLastDraw(a){this.lastDraw.classList.toggle("hidden",!a)}clearBackground(){this.backgroundCtx.fillStyle=
GPPainter_.BACKGROUND_COLOR;this.backgroundCtx.fillRect(0,0,this.background.width,this.background.height)}clearLastDraw(){this.lastDrawCtx.clearRect(0,0,this.lastDraw.width,this.lastDraw.height)}clearCanvas(){this.canvasCtx.clearRect(0,0,this.canvas.width,this.canvas.height)}clearStroke(){this.strokeCtx.clearRect(0,0,this.stroke.width,this.stroke.height)}clearPointer(){this.pointerCtx.clearRect(0,0,this.pointer.width,this.pointer.height)}clearGrid(){this.grid.remove();this.gridType=0}redrawBackground(){this.clearBackground();
this.backgroundData?.length&&this.drawFunction(this.backgroundCtx,this.backgroundData,this.density,!1,this.isNote)}redrawLastDraw(){this.clearLastDraw();this.lastDrawData?.length&&this.drawFunction(this.lastDrawCtx,this.lastDrawData,this.density,!0,this.isNote)}redrawCanvas(){this.clearCanvas();this.history.length&&this.drawFunction(this.canvasCtx,this.history,this.density,!0,this.isNote)}redrawGrid(){this.toggleGrid()}getCanvasCoords(a){return this.zoomer.getCoords(a)}getUnscaledCanvasCoords(a){const [b,
c]=this.getCanvasCoords(a);return[b*this.density,c*this.density]}updateGlobalCoords(a){this.lastClientX=a.clientX;this.lastClientY=a.clientY}resetKeys(){this.container&&(this.container.classList.remove("dropper_","hand_","rotate_","s-rotate_","s-adjustable_","no-pointer_"),this.clearActiveTools(),this.isPerfectShapes=this.isToolCentering=this.isEraser=!1)}initPointerTools(){for(let a in this.tools){if(!this.tools[a].activator)continue;const b=Symbol(a);GPPainter_.ACTIVATOR[a.toUpperCase()]=b;this.tools[a].handler=
this.initPointerTool(b,this.tools[a].activator)}}initPointerTool(a,b){for(const m in b){const p=b[m];"object"!==typeof p?b[m]=p.bind(this):GPUtils_.bindDeep(p,this)}var c=!1,d=!1,e=null;const f=m=>{this.activator&&this.pointerTools.get(this.activator).keyUp();this.activeTool||this.isDrawing||b.keyDown?.();document.addEventListener("keyup",g);this.container.addEventListener("pointerdown",h);c=!0;e=m.code;this.activator=a},g=m=>{m.code===e&&(this.activator===a&&(this.activator=null),d||(b.end?.(),this.updatePointer(),
document.removeEventListener("keyup",g)),b.keyUp?.(),this.container.removeEventListener("pointerdown",h),c=!1)};let k=m=>{};const h=(m,p=!1)=>{if(!this.isDrawing&&this.activator===a&&m.buttons&7){if(!p){if(1===m.button&&b.middleButton){b.middleButton(m);return}if(2===m.button&&b.rightButton){b.rightButton(m);return}}var t=p?0:m.button;b.pointer?.[t]?.hide&&this.container.classList.add("no-pointer_");b.pointer?.[t]?.pointerDown?.(m);b.pointer?.[t]?.pointerMove&&(k=b.pointer[t].pointerMove(m));this.container.setPointerCapture(m.pointerId);
this.container.addEventListener("pointermove",k);this.container.addEventListener("pointerup",r=>{l(r,p)},{once:!0});k(m);this.lockPointer();this.activeTool=a;d=!0}},l=(m,p=!1)=>{this.container.removeEventListener("pointermove",k);k.cancel?.();p=p?0:m.button;b.pointer?.[p]?.hide&&this.container.classList.remove("no-pointer_");b.pointer?.[p]?.pointerUp?.(m);this.updatePointer(m);this.unlockPointer();d=!1;c||b.end?.();this.activeTool=null};this.toolActivators.set(a,m=>{f.bind(this)(m);h(m,!0);g(m)});
this.pointerTools||(this.pointerTools=new Map);this.pointerTools.set(a,{keyUp:()=>{const m=new Event("keyup");m.code=e;g(m)},keyDown:()=>{const m=new Event("keydown");m.code=e;g(m)},pointerUp:()=>{const m=new Event("pointerup");m.clientX=this.lastClientX;m.clientY=this.lastClientY;l(m)}});return f}runPointerTool(a,b,c){this.toolActivators.get(a)?.(b,c)}hasActiveTools(){return!!this.activator}clearActiveTools(){this.activator&&(this.pointerTools.get(this.activator).keyUp(),this.activator=null);this.activeTool&&
(this.pointerTools.get(this.activator).pointerUp(),this.activeTool=null)}dropperKeyDown(a){this.container.classList.add("dropper_")}dropperPointerMove(a){return b=>{let [c,d]=this.getUnscaledCanvasCoords(b);c=this.isMirror?this.width-c:c;d=this.isVerticalMirror?this.height-d:d;const e=this.getPixelColor(c,d);b.buttons&2?this.setColor2(e):this.setColor(e)}}dropperEnd(a){this.container.classList.remove("dropper_")}getPixelColor(a,b){var c=document.createElement("canvas");c.width=1;c.height=1;c=c.getContext("2d");
c.fillStyle=GPPainter_.BACKGROUND_COLOR;c.fillRect(0,0,1,1);this.backgroundData?.length&&c.drawImage(this.background,a,b,1,1,0,0,1,1);this.lastDrawData?.length&&c.drawImage(this.lastDraw,a,b,1,1,0,0,1,1);c.drawImage(this.canvas,a,b,1,1,0,0,1,1);const [d,e,f,g]=c.getImageData(0,0,1,1).data;return g?`${GPColorUtils_.rgbToHex(d,e,f)}`:GPPainter_.BACKGROUND_COLOR}thicknessKeyDown(a){this.renderPointer(...this.getPointerCoords(),void 0,void 0,!0)}thicknessPointerMove(a){const [b,c]=this.getPointerCoords(a),
d=this.s.upThicknessDirection===GPPainter_.DIRECTION.DOWN_RIGHT?1:-1;let e=a.clientX,f=a.clientY;return g=>{const k=Math.round(Math.max(Math.min(this.thickness+(this.s.thicknessAxis===GPPainter_.AXIS.HORIZONTAL?g.clientX-e:g.clientY-f)*d*GPPainter_.CANVAS_DENSITY,this.s.maxThickness),this.s.minThickness));e=g.clientX;f=g.clientY;k&&(this.thickness=k,this.iface.updateThickness(k),this.renderPointer(b,c,void 0,void 0,!0))}}thicknessPointerUp(a){this.dispatchEvent(new CustomEvent("thickness",{detail:{thickness:this.thickness}}))}thicknessRightButton(a){this.thicknessMiddleButton(a)}thicknessMiddleButton(a){this.thickness=
this.s.defaultThickness;this.iface.updateThickness(this.thickness);this.renderPointer(...this.getPointerCoords(),void 0,void 0,!0)}opacityKeyDown(a){this.renderPointer(...this.getPointerCoords(),this.opacity,void 0,!0)}opacityMove(a){const [b,c]=this.getPointerCoords(a),d=this.s.opacityAxis===GPPainter_.AXIS.HORIZONTAL,e=`client${d?"X":"Y"}`,f=this.s.upOpacityDirection===GPPainter_.DIRECTION.UP_LEFT?-1:1,g=this.s.opacitySensitivity*(d?GPPainter_.POINTER_RESOLUTION_RATIO_X:GPPainter_.POINTER_RESOLUTION_RATIO_Y),
k=100*this.opacity/g;let h=a[e]*f;return l=>{l=l[e]*f;const m=(l+k-h)*g;0>m?h=l+k:100<m&&(h=l+k-100/g);this.setOpacity(Math.max(this.s.minOpacity,Math.min(1,Math.round(m)/100)));this.renderPointer(b,c,this.opacity,void 0,!0)}}opacityRightButton(a){this.opacityMiddleButton(a)}opacityMiddleButton(a){this.setOpacity(this.s.defaultOpacity);this.renderPointer(...this.getPointerCoords(),this.opacity,void 0,!0)}brightnessKeyDown(a){this.renderPointer(...this.getPointerCoords(),this.opacity,void 0,!0)}brightnessMove(a){const [b,
...
"vertical-mirror_")}isStreamingTool(a){return GPPainter_.STREAMING_TOOLS.includes(a)}getShortcutsManager(){return this.shortcutsManager}getMirrorState(){return this.isMirror}getVerticalMirrorState(){return this.isVerticalMirror}getGrayscaleState(){return this.isGrayscale}getZoomScale(){return this.zoomer.getScale()}getRotation(){return this.zoomer.getRotation()}saveImage(){const a=document.createElement("canvas");a.width=this.originalWidth;a.height=this.originalHeight;var b=a.getContext("2d");b.drawImage(this.background,
0,0,a.width,a.height);b.drawImage(this.canvas,0,0,a.width,a.height);var c=this.prx.getState();b=c.user.nick;c="string"===typeof c.previous?.data?c.previous.data:"\u043f\u0440\u043e\u0438\u0437\u0432\u043e\u043b\u044c\u043d\u0430\u044f \u0442\u0435\u043c\u0430";const d=(new Date).toLocaleDateString("ru-RU");b=`${b} - ${c} (${d}).png`;c=document.createElement("a");c.href=a.toDataURL();c.download=b;c.click()}clear(){if(!this.isDrawing){if(this.prx.isAnimateMode()){var a=this.getStrokeOptions(GPPainter_.TOOL.ERASER,
void 0,GPPainter_.MAX_THICKNESS);const b=this.getClearStrokeCoords(this.originalWidth,this.originalHeight);a=this.buildStrokeData(a,b);this.dispatchEvent(new CustomEvent("stroke_started",{detail:{data:a}}));this.dispatchEvent(new CustomEvent("stroke_ended",{detail:{data:a}}))}else a=this.getStrokeOptions(GPPainter_.TOOL.RECTANGLE_FILLED,GPPainter_.BACKGROUND_COLOR),a=this.buildStrokeData(a,[[0,0],[this.originalWidth,this.originalHeight]]),this.dispatchEvent(new CustomEvent("stroke_started",{detail:{data:a}}));
this.dispatchEvent(new CustomEvent("stroke",{detail:{data:a}}))}}getClearStrokeCoords(a,b){const c=[];let d=0;for(let e=100;e<=b+100;e+=200)c.push([d,e],[d,e]),d=a-d,c.push([d,e],[d,e]);return c}getTools(){return this.tools}brushTool(){this.setTool(GPPainter_.TOOL.BRUSH);this.iface.updateToolbar(this.tool);this.updatePointer()}eraserTool(){this.setTool(GPPainter_.TOOL.ERASER);this.iface.updateToolbar(this.tool);this.updatePointer()}rectangleTool(){this.setTool(GPPainter_.TOOL.RECTANGLE);this.iface.updateToolbar(this.tool);
this.updatePointer()}rectangleFilledTool(){this.prx.isAnimateMode()||(this.setTool(GPPainter_.TOOL.RECTANGLE_FILLED),this.iface.updateToolbar(this.tool),this.updatePointer())}circleTool(){this.setTool(GPPainter_.TOOL.CIRCLE);this.iface.updateToolbar(this.tool);this.updatePointer()}circleFilledTool(){this.prx.isAnimateMode()||(this.setTool(GPPainter_.TOOL.CIRCLE_FILLED),this.iface.updateToolbar(this.tool),this.updatePointer())}lineTool(){this.setTool(GPPainter_.TOOL.LINE);this.iface.updateToolbar(this.tool);
...
this.isGrayscale);this.dispatchEvent(new CustomEvent("grayscale",{detail:{state:this.isGrayscale}}))}eraser(a){if(!this.isEraser){this.isEraser=!0;var b=this.tool;this.setTool(GPPainter_.TOOL.ERASER);this.iface.updateToolbar(this.tool);var c=d=>{d.code===a.code&&(this.isEraser=!1,this.setTool(b),this.iface.updateToolbar(this.tool),document.removeEventListener("keyup",c))};document.addEventListener("keyup",c)}}toolCentering(a){if(!this.isToolCentering){this.isToolCentering=!0;var b=c=>{c.code===a.code&&
(this.isToolCentering=!1,document.removeEventListener("keyup",b))};document.addEventListener("keyup",b)}}shouldCenteringBeActivated(a){return a===GPPainter_.TOOL.LINE||a===GPPainter_.TOOL.RECTANGLE||a===GPPainter_.TOOL.RECTANGLE_FILLED?this.isToolCentering:a===GPPainter_.TOOL.CIRCLE||a===GPPainter_.TOOL.CIRCLE_FILLED?this.s.centeringCircleTool?!this.isToolCentering:this.isToolCentering:!1}perfectShapes(a){if(!this.isPerfectShapes){this.isPerfectShapes=!0;var b=c=>{c.code===a.code&&(this.isPerfectShapes=
!1,document.removeEventListener("keyup",b))};document.addEventListener("keyup",b)}}symmetryKeyDown(a){this.isSymmetryKeyPressed=!0;this.enableSymmetryAdjustment();this.isSymmetryEnabled?document.addEventListener("keyup",b=>{this.isSymmetryGuidesMoved||this.disableSymmetry()},{once:!0}):this.enableSymmetry()}symmetryKeyUp(a){this.isSymmetryGuidesMoving||(this.disableSymmetryEditing(),this.isSymmetryGuidesMoved=!1);this.isSymmetryKeyPressed=!1}symmetryPointerDown(a){this.isSymmetryGuidesAdjustable&&
...
alias:"pl",dependencies:["GPTimelapsePlayer_"],settings:{storage:"gp_timelapse-player",defaultSettings:this.DEFAULT_SETTINGS,ui:this.SETTINGS_UI},useCSS:!0};constructor(a){super();return;this.prx=a.prx;this.s=a.sm.setSettings(this);this.currentPath=null;GPUtils_.bindMethods([this.onAlbumMiddleClick,this.onAlbumDoubleClick,this.onPreviewMiddleClick,this.onPreviewDoubleClick],this);document.addEventListener("_url_changed",({detail:{path:b}})=>{this.currentPath=b.slice(1)});this.prx.addEventListener("data",
...
r;this.width=this.originalWidth*this.density;this.height=this.originalHeight*this.density;this.originalData=a.slice();const [n,A,C]=this.handleDelimiters(a,b);this.data=n;this.background=A;this.auth=d;this.author=e;this.title=f;this.eraserAlpha=!C;this.fi=g&&this.date.getTime()>GPTimelapsePlayer_.FV2_DATE?5:4;this.container=k;this.container.isPlayerRendered=!0;this.mainContainer=h;this.defaultDisplayMode=l;this.defaultDisplayModeDensity=this.getModeDensity(l);this.cache;this.canvas;this.ctx;this.isPlaying=
!1;this.currentSpeed=JSON.parse(localStorage.getItem("gp-timelapse-player-speed"))||GPTimelapsePlayer_.SPEED;this.speed=GPTimelapsePlayer_.SPEEDS[this.currentSpeed];this.sPos=this.pos=0;this.lastContainerDimension={width:0,height:0};this.isContextLayoutShown=this.expandStateBeforeFullscreen=this.isFullscreen=this.isExpanded=!1;this.isContextMenuDisabled=m;this.isStandalone=!GPTimelapsePlayer_.GARTICPHONE_HOSTNAME_PATTERN.test(location.hostname);this.rotation=0;GPUtils_.bindMethods([this.progressBarPointerMoveHandler,
this.resizeHandler,this.toggleFullscreen,this.playPause,this.drawing,this.expand,this.terminate,this.toggleContextLayout,this.saveImage,this.speedViewPointerMoveHandler,this.stopContentTransition],this);window.addEventListener("resize",this.resizeHandler);this.addEventListener("cache_updated",this.updateCacheHandler);this.initData();this.initCacheWorker()}static closeAll(){GPTimelapsePlayer_.players.forEach(a=>{a.terminate()})}updateCacheHandler({detail:{density:a}}){if(a===this.defaultDisplayModeDensity){this.render();
...
this.pause();this.worker.terminate();this.cache=this.originalData=this.data=null;this.player.remove();this.container.isPlayerRendered=!1;this.container=null;this.speedInput&&this.speedInput.remove();window.removeEventListener("resize",this.resizeHandler);GPTimelapsePlayer_.players.delete(this);this.dispatchEvent(new Event("terminated"))}initData(){const a=[];for(let b=0;b<this.data.length;b++)this.data[b].index=b,this.isMStroke(this.data[b])&&a.push(b);a.reverse().forEach(b=>{this.data.splice(b,1)})}isMStroke(a){return!(1===
a[0]&&a[3][0]>this.originalWidth&&a[3][1]>this.originalHeight)||a[3][0]-this.originalWidth-GPTimelapsePlayer_.M_STROKE_OFFSET||a.at(-1)[1]-this.originalHeight-GPTimelapsePlayer_.M_STROKE_OFFSET?!1:!0}render(){this.player=document.createElement("div");this.player.className="timelapse-player_";this.player.classList.toggle("standalone_",this.isStandalone);this.player.dataset.canvasType=this.canvasTypeName;this.player.style.setProperty("--container-width",`${this.mainContainer.clientWidth}px`);this.player.addEventListener("click",
e=>{e.stopPropagation()});this.player.addEventListener("pointerdown",e=>{e.stopPropagation()});this.player.addEventListener("pointerup",e=>{e.stopPropagation()});this.player.addEventListener("mouseup",e=>{e.stopPropagation()});this.player.addEventListener("mousedown",e=>{e.preventDefault();e.stopPropagation();1===e.button&&(this.isFullscreen?this.toggleFullscreen():this.expand())},!0);this.player.addEventListener("contextmenu",e=>{e.stopPropagation();e.preventDefault();this.toggleContextLayout()});
this.player.addEventListener("fullscreenchange",e=>{this.isFullscreen=!!document.fullscreenElement;this.player.classList.toggle("fullscreen_",this.isFullscreen);this.mainContainer.classList.toggle("gp-tp-fullscreen_",this.isFullscreen);this.isStandalone&&!this.isFullscreen?this.expand(this.expandStateBeforeFullscreen):this.resizeHandler()});this.content=document.createElement("div");this.content.className="content_";this.content.addEventListener("transitionend",this.stopContentTransition);this.player.appendChild(this.content);
this.bgCanvas=document.createElement("canvas");this.bgCanvas.className="background-canvas_";this.bgCanvas.width=this.width;this.bgCanvas.height=this.height;this.content.appendChild(this.bgCanvas);this.bgCtx=this.bgCanvas.getContext("2d");this.bgCtx.fillStyle=GPTimelapsePlayer_.BACKGROUND_COLOR;this.bgCtx.fillRect(0,0,this.bgCanvas.width,this.bgCanvas.height);this.background&&this.drawFunction(this.bgCtx,this.background,this.density,!1);this.canvas=document.createElement("canvas");this.canvas.className=
"canvas_";this.canvas.width=this.width;this.canvas.height=this.height;this.content.appendChild(this.canvas);this.ctx=this.canvas.getContext("2d",{willReadFrequently:!0});this.strokeCanvas=document.createElement("canvas");this.strokeCanvas.className="stroke-canvas_";this.strokeCanvas.width=this.width;this.strokeCanvas.height=this.height;this.content.appendChild(this.strokeCanvas);this.strokeCtx=this.strokeCanvas.getContext("2d");var a=document.createElement("div");a.className="event-catcher_";a.addEventListener("click",
this.playPause);a.addEventListener("dblclick",this.toggleFullscreen);this.player.appendChild(a);a=document.createElement("div");a.className="controls_";a.style.cssText="";this.player.appendChild(a);const b=document.createElement("div");b.className="progress-bar_";b.addEventListener("pointermove",e=>{const [f,,g]=this.getCoords(e);d.style.width=`${100*Math.max(0,Math.min(1,f/g))}%`},!0);b.addEventListener("pointerdown",e=>{if(0===e.button){var f=this.isPlaying;this.progress.classList.remove("smooth_");
this.player.classList.toggle("finished_",this.pos===this.data.length-1);this.progressBarPointerMoveHandler(e);b.setPointerCapture(e.pointerId);b.addEventListener("pointermove",this.progressBarPointerMoveHandler);b.addEventListener("pointerup",g=>{b.removeEventListener("pointermove",this.progressBarPointerMoveHandler);this.progress.classList.add("smooth_");this.player.classList.toggle("finished_",this.pos===this.data.length);f&&this.pos<this.data.length&&this.play()},{once:!0})}});a.appendChild(b);
var c=document.createElement("div");c.className="progress-bar-bg_";b.appendChild(c);const d=document.createElement("div");d.className="progress-hover_";b.appendChild(d);this.progress=document.createElement("div");this.progress.className="progress_ smooth_";this.updateProgress();b.appendChild(this.progress);c=document.createElement("div");c.className="play-btn_ btn_";c.title="\u0417\u0430\u043f\u0443\u0441\u0442\u0438\u0442\u044c/\u041e\u0441\u0442\u0430\u043d\u043e\u0432\u0438\u0442\u044c \u043f\u0440\u043e\u0438\u0433\u0440\u044b\u0432\u0430\u043d\u0438\u0435";
...
k=(e.clientY-g-(e.clientY-e.target.getBoundingClientRect().y))/this.scaleY;this.renderSpeedInput((e.clientX-f)/this.scaleX,k);this.speedView.setPointerCapture(e.pointerId);this.speedView.addEventListener("pointermove",this.speedViewPointerMoveHandler);this.speedView.addEventListener("pointerup",h=>{this.speedView.removeEventListener("pointermove",this.speedViewPointerMoveHandler);this.speedInput?.remove()},{once:!0})});this.strokeNumView=document.createElement("div");this.strokeNumView.className=
"stroke_";this.strokeNumView.title="\u0422\u0435\u043a\u0443\u0449\u0438\u0439 \u0448\u0442\u0440\u0438\u0445";this.strokeNumView.textContent=" ";this.updateStrokeView();a.appendChild(this.strokeNumView);a.appendChild(document.createElement("span"));c=document.createElement("div");c.className="rotate-btn_ btn_";c.title="\u041f\u043e\u0432\u0435\u0440\u043d\u0443\u0442\u044c \u043d\u0430 90\u00b0";c.addEventListener("click",e=>{this.rotate(!e.ctrlKey&&!e.shiftKey)});a.appendChild(c);c=document.createElement("div");
c.className="expand-btn_ btn_";c.title="\u0420\u0430\u0437\u0432\u0435\u0440\u043d\u0443\u0442\u044c/\u0421\u0432\u0435\u0440\u043d\u0443\u0442\u044c";c.addEventListener("click",e=>{this.expand()});a.appendChild(c);c=document.createElement("div");c.className="fullscreen-btn_ btn_";c.title="\u0420\u0430\u0437\u0432\u0435\u0440\u043d\u0443\u0442\u044c \u043d\u0430 \u0432\u0435\u0441\u044c \u044d\u043a\u0440\u0430\u043d";c.addEventListener("click",this.toggleFullscreen);a.appendChild(c);a=document.createElement("div");
a.className="close-btn_";a.title="\u0417\u0430\u043a\u0440\u044b\u0442\u044c \u043f\u0440\u043e\u0438\u0433\u0440\u044b\u0432\u0430\u0442\u0435\u043b\u044c";a.addEventListener("click",this.terminate);this.player.appendChild(a);this.contextLayout=document.createElement("div");this.contextLayout.className="context-layout_";this.contextLayout.addEventListener("click",this.toggleContextLayout);a=document.createElement("div");a.className="save-img-data-btn_ btn_";a.title="\u0421\u043e\u0445\u0440\u0430\u043d\u0438\u0442\u044c \u0438\u0441\u0445\u043e\u0434\u043d\u0438\u043a";
...
b,c,d)}else this.drawFunction(a,b,c,d)}}drawFunction(a,b,c=this.density,d=this.eraserAlpha,e=!1){GPUtils_.drawFunction(a,b,c,d,e)}handleDelimiters(a,b){const c=a.findLastIndex(d=>11===d[0]);if(~c){const d=a.slice(c+1);a=(b??[]).concat(a.slice(0,c).filter(e=>11!==e[0]));return[d,a,!0]}return[a,b,!1]}initCacheWorker(){let {width:a,height:b}=getComputedStyle(this.container);a=parseInt(a);b=parseInt(b);var {density:c}=this.getDensityByDimensions(a,b);let {width:d,height:e}=getComputedStyle(this.mainContainer);
d=parseInt(d);e=parseInt(e);const {density:f}=this.getDensityByDimensions(d,e),{density:g}=this.getDensityByDimensions(window.screen.width,window.screen.height),k=[...(new Set([c,f,g]))];this.worker||(c=URL.createObjectURL(new Blob([this.getFuncBody(this.cacheWorkerBody)])),this.worker=new Worker(c),URL.revokeObjectURL(c),this.worker.addEventListener("message",({data:h})=>{"worker-ready"===h.type?k.forEach(l=>{this.worker.postMessage({type:"get-cache",density:l})}):"cache-updated"===h.type&&(this.cache=
h.cache,this.dispatchEvent(new CustomEvent("cache_updated",{detail:{density:h.density}})))}));this.worker.postMessage({type:"init",data:this.data,background:this.background,eraserAlpha:this.eraserAlpha,drawFunctionString:GPUtils_.drawFunctionString,fi:this.fi,CACHE_INTERVAL:GPTimelapsePlayer_.CACHE_INTERVAL,ORIGINAL_WIDTH:this.originalWidth,ORIGINAL_HEIGHT:this.originalHeight,BACKGROUND_COLOR:GPTimelapsePlayer_.BACKGROUND_COLOR})}cacheWorkerBody(){function a(f){var g=b*f,k=c*f;if(!this.cache[f]){this.cache[f]=
[];const l=e,m=Math.floor(self.data.length/l);g=new OffscreenCanvas(g,k);k=g.getContext("2d",{willReadFrequently:!0});let p;self.background&&(k.fillStyle=d,k.fillRect(0,0,g.width,g.height),self.draw(k,this.background,f,!1),p=k.getImageData(0,0,g.width,g.height),k.clearRect(0,0,g.width,g.height));for(let t=0;t<m;t++){var h=t*l;h=self.data.slice(h,h+l);self.draw(k,h,f,self.eraserAlpha);h=k.getImageData(0,0,g.width,g.height);this.cache[f].push(h)}self.background&&this.cache[f].push(p)}}let b,c,d,e;self.data;
self.draw;self.cache=[];self.addEventListener("message",({data:f})=>{"init"===f.type?(self.data=f.data,self.background=f.background,self.eraserAlpha=f.eraserAlpha,self.fi=f.fi,self.draw=(new Function(`return ${f.drawFunctionString}`))(),e=f.CACHE_INTERVAL,b=f.ORIGINAL_WIDTH,c=f.ORIGINAL_HEIGHT,d=f.BACKGROUND_COLOR,self.postMessage({type:"worker-ready"})):"get-cache"===f.type&&(self.cache[f.density]||a(f.density),self.postMessage({type:"cache-updated",cache:self.cache,density:f.density}))})}getFuncBody(a){a=
