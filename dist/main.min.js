...
d.appendChild(c);const e=new Set;Array.from(a.values()).forEach((f,g)=>{var k=`${f.url}?${Date.now()}.user.js`;const h=document.createElement("div");h.className="oudated-script_";var l=document.createElement("div");l.textContent=f.name;h.appendChild(l);l=document.createElement("div");l.textContent=`${f.version} \u2794 ${f.latestVersion}`;h.appendChild(l);l=document.createElement("div");h.appendChild(l);const m=document.createElement("a");m.className="script-update-link_";m.href=k;m.target="_blank";
m.textContent=this.l.UPDATE_SCRIPT;k=p=>{e.add(g);e.size>=a.size&&d.classList.add("shown_");m.closest(".oudated-script_").classList.add("clicked_")};m.addEventListener("click",k);m.addEventListener("auxclick",k);l.appendChild(m);b.appendChild(h)});b.appendChild(d);return b}getVersion(){return this.version}getWindowsInkWarningState(){return this.s.windowsInkWarning}setWindowsInkWarningState(a){this.s.windowsInkWarning=a}showUpdateNotice(){const [a,
...
ss:Number(f)}}))});document.addEventListener("gp:prx.auth_id",async({detail:{authId:c,authTypeId:d,isAuthorized:e}})=>{function f(x){this.lm=this.lm.filter(y=>1<<y.id&x?(y.disabled||y.initialized||this.initModuleInstance(y,this.root,this.loc.get(y.name)),y.locked=!1):y.locked=!0);this.renderModulesList()}async function g(x,y){y=(new TextEncoder).encode(y);var v=await crypto.subtle.digest("SHA-256",y);y=window.atob(x).slice(0,12);y={name:"AES-GCM",iv:new Uint8Array(Array.from(y).map(r=>r.charCodeAt(0)))};
v=await crypto.subtle.importKey("raw",v,y,!1,["decrypt"]);x=window.atob(x).slice(12);x=new Uint8Array(Array.from(x).map(r=>r.charCodeAt(0)));try{const r=await crypto.subtle.decrypt(y,v,x);return(new TextDecoder).decode(r)}catch(r){throw new GPDecryptError_;}}function k(x){document.dispatchEvent(new CustomEvent("gp:act.auth_perms",{detail:{ps:x}}))}async function h(x){x=await g(x,l());return fetch("https://id.twitch.tv/oauth2/validate",{headers:{Authorization:`OAuth ${x}`},credentials:"omit",cache:"no-cache"}).then(y=>
{if(y.ok)return y.json();throw Error();}).then(y=>[y.user_id,y.login]).catch(()=>[])}function l(){function x(w,F){const K=y();return x=function(Q,V){Q-=195;let z=K[Q];void 0===x.IvNImK&&(x.biwoho=function(J){let I="",H="";for(let C=0,N,P,R=0;P=J.charAt(R++);~P&&(N=C%4?64*N+P:P,C++%4)?I+=String.fromCharCode(255&N>>(-2*C&6)):0)P="abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789+/=".indexOf(P);for(let C=0,N=I.length;C<N;C++)H+="%"+("00"+I.charCodeAt(C).toString(16)).slice(-2);return decodeURIComponent(H)},
w=arguments,x.IvNImK=!0);const G=Q+K[0],E=w[G];return E?z=E:(z=x.biwoho(z),w[G]=z),z},x(w,F)}function y(){const w="mZmYvMvlr1vW yxrVyG ndq1mJu4offSB0n4Aa mJqZnZKYvwvXC0TJ yJnoAMni uNbIv1zhyJnkDa vMHAmLu9 yuDgEvPi zgHKrZL5 EeLAv2XUyuHrpq yKDgDvOZ mJmZmtvWze92EgO EdjAv1jqy0HsCa uKDgmfPw BwfW mJm0BNnKqvHr zfHoBgnR yvCXmwjb nZyYmZG4ohvMwM96ra rM5AvZuWuKDgma zgHJBvzeyJi1AG sw50Ba nM9RwxbMEq mJCZody2mhjjweLLrq y21wEMiY y0D4Agrh wvHrpq mZu3m1nVA1f5Bq zeDSDfPw wvHAAgfx wKDwmMfx y2HHCKnVzgvbDa mZy4mZCXu1LtDvvr yM1gmMfx".split(" ");
y=function(){return w};return y()}(function(w,F){const K=x;for(w=w();;)try{if(parseInt(K(219))/1+parseInt(K(202))/2*(-parseInt(K(214))/3)+-parseInt(K(221))/4*(-parseInt(K(198))/5)+parseInt(K(209))/6*(parseInt(K(223))/7)+-parseInt(K(205))/8+-parseInt(K(224))/9+parseInt(K(210))/10===F)break;else w.push(w.shift())}catch(Q){w.push(w.shift())}})(y,545929);const v=x,r=[v(220)+v(195),v(203)+(v(206)+"YQ=="),"","",v(212)+"Zvcm0=",v(228)+(v(207)+"dXJyZW5jeQ=="),"c2NyZWVu",v(216)+"xXaWR0aA==","YXZhaW"+v(196),
v(197)+v(227),"",v(225)+"U=",v(217)+"NlTWVtb3J5",v(200)+(v(226)+v(213)),v(211)+(v(199)+"b25z"),v(215)+"pvbmU=",v(204)+"=="][v(201)](window[v(222)]),D=JSON.stringify([window[r[0]][r[1]]?.[r[4]],window[r[0]][r[5]],window[r[6]][r[7]],window[r[6]][r[8]],window[r[0]][r[9]],window[r[0]][r[4]],window[r[0]][r[11]],window[r[0]][r[12]],(new (window[v(208)]?.[r[13]]))[r[14]]()[r[15]]]);let B=-559038803,A=1103547925;for(let w=0,F;w<D.length;w++)F=D[v(218)](w),B=Math[r[16]](B^F,2654435761),A=Math[r[16]](A^F,1597334677);
return B=Math[r[16]](B^B>>>16,2246822507)^Math[r[16]](A^A>>>13,3266489909),A=Math[r[16]](A^A>>>16,2246822507)^Math[r[16]](B^B>>>13,3266489909),String(4294967296*(2097151&A)+(B>>>0))}this.s.allowAnalytics||(this.setEditionState(GPModulesManager_.STATE.ANALYTICS),await this.waitForAnalyticsConsent());let m=!1,p=!1,t=!1,q={};if(this.lm.length){var n=GPModulesManager_.DEFAULT_PERMISSIONS,u=null;try{if(!a||!this.publicKey)throw u=[GPModulesManager_.STATE.KEY],new GPAuthError_;if(!d)if(this.s.twitchAuth){d=
1;const [v,r]=await h(this.s.twitchAuth);if(c=v)this.root.prx.setTwitchOAuth(r);else throw this.s.twitchAuth=null,this.root.abt?.showTwitchOAuthTokenNotice({onButtonClick:()=>{this.requestTwitchToken()}}),new GPAuthError_;}else throw new GPAuthError_;const x=1===d?"t":"d";q=JSON.parse(await g(a,this.publicKey));let y;try{y=JSON.parse(await g(q[x],c))}catch{throw u=[GPModulesManager_.STATE.MISMATCH],new GPDecryptError_;}q.e&&this.setEditionTitle(q.e,q.m);q.g&&(u=[GPModulesManager_.STATE.GIFT]);if(y.ed){p=
!0;if(y.ed<Date.now())throw t=!0,u=[GPModulesManager_.STATE.EXPIRED],2&y.p&&(n|=16),new GPAuthError_;u=[GPModulesManager_.STATE.TIME_LEFT,y.ed-Date.now()]}else q.g||(u=[GPModulesManager_.STATE.SUBSCRIPTION]);u&&this.setEditionState(...u);f.call(this,n|y.p);k.call(this,n|y.p);this.renderModulesList();m=!0}catch(x){x instanceof GPAuthError_||x instanceof GPDecryptError_||console.error(x),u||(e?u??=[GPModulesManager_.STATE.SUBSCRIBE]:this.publicKey&&(u??=[GPModulesManager_.STATE.AUTH])),u&&this.setEditionState(...u),
f.call(this,n),k.call(this,n)}this.dispatchEvent(new CustomEvent("modules_loaded",{detail:{decryptedData:q,authTypeId:d,isAuthorized:e,isSubscribed:m,kd:p,kt:t}}));this.handleSubExpiration(u)}else this.dispatchEvent(new CustomEvent("modules_loaded",{detail:{decryptedData:q,authTypeId:d,isAuthorized:e,isSubscribed:m,kd:p,kt:t}}))});document.addEventListener("gp:act.auth_key_changed",c=>{this.container.classList.add("reload-required_")});document.addEventListener("gp:act.auth_key",({detail:{publicKey:c}})=>
...
{d.onsuccess=f=>{const g=f.target.result;f=this.filterDBStores(g).map(k=>new Promise(h=>{const l=g.transaction(k,"readonly").objectStore(k);l.getAll().onsuccess=m=>{h({name:l.name,keyPath:l.keyPath,autoIncrement:l.autoIncrement,indexes:[...l.indexNames].map(p=>{const {name:t,keyPath:q,unique:n,multiEntry:u}=l.index(p);return{name:t,keyPath:q,unique:n,multiEntry:u}}),entries:m.target.result})}}));Promise.all(f).then(k=>e({name:g.name,version:g.version,stores:k}))}})});Promise.all(b).then(async c=>
...
k=>{const h=k.target.result;g.map(l=>{const m=h.createObjectStore(l.name,{keyPath:l.keyPath,autoIncrement:l.autoIncrement});l.indexes.forEach(p=>{const {name:t,keyPath:q,...n}=p;m.createIndex(t,q,n)})})};f.onsuccess=k=>{const h=k.target.result;k=g.map(l=>new Promise(m=>{const p=h.transaction(l.name,"readwrite");p.oncomplete=m;const t=p.objectStore(l.name);t.clear().onsuccess=()=>{l.entries.forEach((q,n)=>{t.add(q,l.keyPath?void 0:n)})}}));Promise.all(k).then(d)};f.onerror=e})),await Promise.allSettled(a));
...
t,e,p);break;case "buttons":const q=document.createElement("div");q.className="buttons_";q.dataset.name=t;m.getButtons().forEach(u=>{u.classList.add("btn_");q.appendChild(u)});k.appendChild(q);this.setControlStateAndDependents(f,t,e,q);break;default:p=document.createElement("div");p.className="setting_";p.dataset.name=t;const n=GPUtils_.buildTooltip(m.description);p.appendChild(n);m=this.buildName(t,m.description);p.appendChild(m);m=this.buildControl(f,t,e[t],c,d,e,g);p.appendChild(m);k.appendChild(p);
...
args:h,formatter:l,l10n:m,inputTrigger:p,beforeActivation:t}=a[b],q=document.createElement("div");q.className="control_";let n;switch(k){case "switch":n=document.createElement("div");n.className="gp-ui-switch_";var u=`ctrl-${g.view.dataset.viewIndex}-${b}_`;const x=document.createElement("input");x.id=u;x.type="checkbox";x.name=b;x.checked=c;if(t){let z=!1;x.addEventListener("click",async G=>{G.preventDefault();if(!z){if(x.checked&&(z=!0,G=await t(),z=!1,!G))return;requestAnimationFrame(()=>{x.checked=
!x.checked;x.dispatchEvent(new Event("change",{bubbles:!0}))})}})}n.appendChild(x);const y=document.createElement("label");y.setAttribute("for",u);n.appendChild(y);q.appendChild(n);break;case "slider":const {min:v,max:r,step:D,reverse:B}=h;n=document.createElement("input");n.className="gp-ui-slider_";n.type="range";n.min=v;n.max=r;n.step=D;n.value=c;n.name=b;B&&(n.style.direction="rtl");n.addEventListener("input",z=>{A.textContent=l?l(Number.parseFloat(z.target.value)):z.target.value});const A=document.createElement("div");
A.className="gp-ui-slider-preview_";A.textContent=l?l(c):c;A.addEventListener("pointerdown",z=>{let G=z.clientY;const E=I=>{var H=I.clientY-G;const C=0>H;Math.abs(H)>=GPSettingsManager_.POINTER_SLIDER_PREVIEW_CHANGE_SENSITIVITY&&(H=n.valueAsNumber,H+=(B?!C:C)?D:-D,H=Math.max(Math.min(H,r),v),H=Math.round(1E3*H)/1E3,n.value=H,A.textContent=l?l(H):H,n.dispatchEvent(new Event("change",{bubbles:!0})),G=I.clientY)},J=I=>{const H=0>I.deltaY;let C=n.valueAsNumber;C+=(B?!H:H)?D:-D;C=Math.max(Math.min(C,r),
v);C=Math.round(1E3*C)/1E3;n.value=C;A.textContent=l?l(C):C;n.dispatchEvent(new Event("change",{bubbles:!0}));I.preventDefault();I.stopPropagation();I.stopImmediatePropagation()};z.currentTarget.setPointerCapture(z.pointerId);z.currentTarget.addEventListener("pointermove",E);z.currentTarget.addEventListener("pointerup",I=>{I.currentTarget.removeEventListener("pointermove",E);document.removeEventListener("wheel",J,{passive:!1});n.focus()},{once:!0});document.addEventListener("wheel",J,{passive:!1})});
q.appendChild(n);q.appendChild(A);break;case "list-numbers":({items:u}=h);n=document.createElement("form");n.className="gp-ui-list-n_";n.value=c;n.name=b;u.forEach(({min:z,max:G,step:E,reverse:J},I)=>{const H=document.createElement("input");H.type="range";H.value=c[I];H.name=b;n.appendChild(H);const C=document.createElement("div");C.className="gp-ui-slider-preview_";C.textContent=l?l(c[I]):c[I];C.addEventListener("animationend",N=>{"list-n-item-highlight_"!==N.animationName&&"list-n-item-fadeout_"!==
...
n.appendChild(C)});q.appendChild(n);break;case "input":u=h?.secure;n=document.createElement("input");n.className="gp-ui-input_";n.classList.toggle("secure-input_",!!u);n.spellcheck=!1;n.autocomplete="off";n.value=c;n.name=b;n.addEventListener("keydown",z=>{switch(z.key){case "Escape":z.target.value=z.target.dataset.initialValue;case "Enter":z.target.blur()}});n.addEventListener("focus",z=>{z.target.dataset.initialValue=z.target.value});n.addEventListener("blur",z=>{delete z.target.dataset});GPUtils_.setInputFocusBlurHandler(n);
q.appendChild(n);break;case "dropdown":n=document.createElement("select");n.className="gp-ui-dropdown_";n.autocomplete="off";n.name=b;const {items:w,itemsProxySetting:F}=h;(F&&f[F]||(w?.length?w:[c])).forEach((z,G)=>{const E=document.createElement("option");E.value=z;E.textContent=l?l(z,G):z;n.appendChild(E)});n.value=c;q.appendChild(n);break;case "list-multiple":case "list-multiple-dynamic":u="list-multiple"===k?h.items:c;n=document.createElement("form");n.className="gp-ui-list-m_";n.name=b;u.forEach((z,
G)=>{const E=`ctrl-${g.view.dataset.viewIndex}-${b}-${G}_`,J=document.createElement("input");J.id=E;J.type="checkbox";J.value=z;J.name=b;J.checked=c.includes(z);n.appendChild(J);z=m&&d.l?d.l[m[G]]:l?l(z,G):z;G=document.createElement("label");G.textContent=z;G.title=z;G.setAttribute("for",E);n.appendChild(G)});q.appendChild(n);break;case "list-icons":const {icons:K}=h;n=document.createElement("form");n.className="gp-ui-list-i_";n.name=b;const Q=[];Object.keys(K).forEach((z,G)=>{G=`ctrl-${g.view.dataset.viewIndex}-${b}-${G}_`;
...
n.type="color";n.value=c;n.name=b;q.appendChild(n);break;case "colors":const {proportions:V}=h;n=document.createElement("form");n.className="gp-ui-colors_";n.value=c;n.name=b;c.forEach((z,G)=>{const E=document.createElement("input");E.type="color";E.value=z;E.name=b;E.style.flex=V[G]??1;E.addEventListener("change",J=>{c[G]=J.target.value;E.dispatchEvent(new Event("change",{bubbles:!0}))});n.appendChild(E)});q.appendChild(n)}u=["change","input"];for(let x=0;x<(p?2:1);x++)n.addEventListener(u[x],y=>
{y={[y.target.name]:this.parseValue(y.target,k)};this.dispatchEvent(new CustomEvent("update",{detail:{module:d,storage:e,settings:Object.assign(f,y),changedSettings:y}}));0===x&&this.updateViews(g.view.moduleName,g.view)});n.addEventListener("change",x=>{a[b].dependents&&a[b].dependents.forEach(y=>{this.updateControlState(y,a,f,g)})});return q}resetPreviewAnimation(a){a.classList.remove("up_","down_");a.offsetLeft}updatePreviewAnimation(a,b){b=b?"up_":"down_";a.classList.remove("up_","down_");a.offsetLeft;
...
b){const c=GPDrawInterface_.THICKNESSES,d=Number.parseInt(getComputedStyle(a).width),e=(a.clientWidth-d)/2,f=b.offsetWidth,g=(d-c.length*f)/(c.length-1);return[0,...c.slice(0,-1).map((k,h)=>e+(h+1)*f+h*g+g/2),d+2*e]}updateReadyBtn(a){a??this.painter.prx.isReady()?(this.readySvg.innerHTML=GPDrawInterface_.READY_BUTTON_ICON_SVG.EDIT,this.readyLabel.textContent=this.painter.localization.edit):(this.readySvg.innerHTML=GPDrawInterface_.READY_BUTTON_ICON_SVG.READY,this.readyLabel.textContent=this.painter.localization.ready)}updateColorPickerPanel(a){this.colorPanel.updateColorPickerPanel(a)}updatePanelsBackground(a,
b){const c=parseInt(a.substr(1,2),16),d=parseInt(a.substr(3,2),16),e=parseInt(a.substr(5,2),16);this.style.setProperty("--gp-panels-bg-color",`rgb(${c} ${d} ${e} / ${b}%)`);const [f,g,k]=GPColorUtils_.rgbToHsv(c,d,e),[h,l,m]=GPColorUtils_.hsvToRgb(Math.max(f-.04246122552758713,0),Math.max(g-.012523565849717255,0),Math.max(k-.05882352941176472,0));this.style.setProperty("--gp-panels-elems2-color",`rgb(${h}, ${l}, ${m})`);this.colorPanel?.updatePanelsBackground(a)}updatePanelsElements(a,b){const c=
...
b)/100;c=Math.round(1E4*c)/100;d=Math.round(1E4*d)/100;var e=(b- -5.36+92.59)%360;const f=this.calcHeaderFilterValue(66.86,78.64,c),g=this.calcHeaderFilterValue(34.31,20.2,d);var k=(b-5.72+103.67)%360,h=this.calcHeaderFilterValue(66.86,72.41,c);const l=this.calcHeaderFilterValue(34.31,60.2,d);e=`hue-rotate(${e}deg) saturate(${f}) brightness(${g})`;k=`hue-rotate(${k}deg) saturate(${h}) brightness(${l})`;h=this.screen.querySelector(":scope .draw").style;h.setProperty("--gp-text-stroke",`hsl(${b-4.27}deg 100% ${Math.max(d-
21.37,0)}%)`);h.setProperty("--gp-book-border-color",`hsl(${b-10.16}deg ${Math.max(c+24.18,0)}% ${Math.max(d-20,0)}%)`);h.setProperty("--gp-book-bg-color",`hsl(${b-7.03}deg ${Math.max(c-4.05,0)}% ${Math.max(d-14.12,0)}%)`);h.setProperty("--gp-book-rings-filter",k);h.setProperty("--gp-header-color",a);h.setProperty("--gp-header-bs-color",`hsl(${b-5.9}deg ${Math.max(c-3.28,0)}% ${Math.max(d+14.9,0)}%)`);h.setProperty("--gp-header-border-bottom-color",`hsl(${b-6.19}deg ${Math.max(c+10.43,0)}% ${Math.max(d-
25.29,0)}% / 50%)`);h.setProperty("--gp-header-logo-bg-filter",e);h.setProperty("--gp-core-bs-color",`hsl(${b-6.66}deg ${Math.max(c-4.95,0)}% ${Math.max(d-26.28,0)}%)`)}calcHeaderFilterValue(a,b,c){return Math.round(Math.min(Math.max(c-(a-b),0),100)/b*100)/100}toggleInteractionHints(a){this.screen.classList.toggle("gp-hints_",!!a)}updateInteractionHintsDelay(a){this.style.setProperty("--gp-hints-delay",`${a}s`)}updateHeaderPhraseColor(a){this.style.setProperty("--gp-header-phrase-color",a)}updateActionQueueSize(a,
...
defaultThickness:{type:"slider",args:{min:1,max:200,step:1},description:"\u0422\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0443\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u0435\u0442\u0441\u044f \u0432 \u043d\u0430\u0447\u0430\u043b\u0435 \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0440\u0430\u0443\u043d\u0434\u0430)"},defaultOpacity:{type:"slider",args:{min:.01,max:1,step:.01},description:"\u041d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u044c \u043a\u0438\u0441\u0442\u0438 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0443\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u0435\u0442\u0441\u044f \u0432 \u043d\u0430\u0447\u0430\u043b\u0435 \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0440\u0430\u0443\u043d\u0434\u0430)"},
_2:{text:"Thickness"},minThickness:{type:"slider",args:{min:1,max:200,step:1},description:"\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"},maxThickness:{type:"slider",args:{min:1,max:200,step:1},description:"\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c"},
...
thicknessStep:{type:"slider",args:{min:1,max:10,step:1},description:"\u0428\u0430\u0433 \u0438\u0437\u043c\u0435\u043d\u0435\u043d\u0438\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u044b \u043a\u0438\u0441\u0442\u0438 \u043f\u0440\u0438 \u0438\u0441\u043f\u043e\u043b\u044c\u0437\u043e\u0432\u0430\u043d\u0438\u0438 \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448"},customThickness:{type:"list-numbers",args:{items:[{min:1,max:200,step:1},{min:1,max:200,
step:1},{min:1,max:200,step:1},{min:1,max:200,step:1},{min:1,max:200,step:1}]},description:"\u041f\u0440\u043e\u0438\u0437\u0432\u043e\u043b\u044c\u043d\u044b\u0435 \u0437\u043d\u0430\u0447\u0435\u043d\u0438\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u044b \u043a\u0438\u0441\u0442\u0438 \u0434\u043b\u044f \u0431\u044b\u0441\u0442\u0440\u043e\u0433\u043e \u0432\u044b\u0431\u043e\u0440\u0430 \u0441 \u043f\u043e\u043c\u043e\u0449\u044c\u044e \u043a\u043e\u043c\u0431\u0438\u043d\u0430\u0446\u0438\u0439 \u043a\u043b\u0430\u0432\u0438\u0448"},
...
_6:{text:"Pointer"},pointerOpacity:{type:"slider",args:{min:0,max:1,step:.1},description:"\u041f\u0440\u043e\u0437\u0440\u0430\u0447\u043d\u043e\u0441\u044c \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u044f"},_7:{text:"Color Picker"},colorPickerHuePosition:{type:"dropdown",
...
return[(d-c.left)*this.density/b*GPPainter_.CANVAS_DENSITY,(a-c.top)*this.density/b*GPPainter_.CANVAS_DENSITY]}renderPointer(b,c,d,e=this.thickness,f,h){this.clearPointer();e=this.activator==="zoom"?1:!f&&GPPainter_.TOOLS_THICKNESSES[this.tool]||e;this.tool!==GPPainter_.TOOL.ERASER||!this.s.doubleEraserThickness||this.isEraser&&this.s.disableDoubleEraserThicknessOnShortcut||
(e*=2);e*=this.zoomer.getScale();d=this.activeTool==="thickness"||this.activator!=="opacity"&&this.activator!=="brightness"?d:this.opacity;f=this.pointerCtx;var g=Math.min(Math.max(this.zoomer.getScale(),1),2)*GPPainter_.CANVAS_DENSITY;f.lineWidth=g;var l=e/2*this.density;f.beginPath();f.arc(b,c,l,0,2*Math.PI);d&&(f.fillStyle=`rgba(${GPColorUtils_.hexToRgb(this.color).join(",")},${d}`,f.fill());f.strokeStyle=GPPainter_.POINTER_COLOR;f.stroke();
f.beginPath();f.arc(b,c,l+g,0,2*Math.PI);f.strokeStyle=GPPainter_.POINTER_OUTLINE_COLOR;f.globalAlpha=.5;f.stroke();f.globalAlpha=this.s.pointerOpacity;if(2>e){var m=GPPainter_.CANVAS_DENSITY;e=3*Math.max(e,2)*m;g=GPPainter_.POINTER_CROSSHAIR_LINE_LENGTH*m;l=1*m;var n=1*m;m=l+2*n;const p=e-n;n=g+2*n;f.beginPath();f.moveTo(b,c-p);f.lineTo(b,c-p-n);f.moveTo(b+p,c);f.lineTo(b+p+n,c);f.moveTo(b,c+p);f.lineTo(b,c+p+n);f.moveTo(b-p,c);f.lineTo(b-p-n,c);f.globalAlpha=.5;f.strokeStyle=GPPainter_.POINTER_OUTLINE_COLOR;
f.lineWidth=m;f.stroke();f.beginPath();f.moveTo(b,c-e);f.lineTo(b,c-e-g);f.moveTo(b+e,c);f.lineTo(b+e+g,c);f.moveTo(b,c+e);f.lineTo(b,c+e+g);f.moveTo(b-e,c);f.lineTo(b-e-g,c);f.globalAlpha=this.s.pointerOpacity;f.strokeStyle=GPPainter_.POINTER_COLOR;f.lineWidth=l;f.stroke();f.globalAlpha=this.s.pointerOpacity}if(h){const [p,q]=h;f.beginPath();f.arc(p,q,GPPainter_.POINTER_DOT_THICKNESS/2*this.density,0,2*Math.PI);d&&(f.fillStyle=`rgba(${GPColorUtils_.hexToRgb(this.color).join(",")},${d}`,f.fill());
f.strokeStyle=GPPainter_.POINTER_COLOR;f.stroke();f.beginPath();f.arc(p,q,(GPPainter_.POINTER_DOT_THICKNESS/2+1)*this.density,0,2*Math.PI);f.strokeStyle=GPPainter_.POINTER_OUTLINE_COLOR;f.globalAlpha=this.s.pointerOutlineOpacity;f.stroke();f.globalAlpha=this.s.pointerOpacity}}setTool(a){this.tool=a;a=a===GPPainter_.TOOL.NOTE;const b=a!==this.isNote;this.isNote=a;b&&(this.redrawBackground(),this.redrawLastDraw(),this.redrawCanvas())}getColor(){return this.color}getColor2(){return this.color2}setColor(a){this.colorPicker.setColor(a);
...
this.activeTool||this.isDrawing||b.keyDown?.();document.addEventListener("keyup",g);this.container.addEventListener("pointerdown",h);c=!0;e=m.code;this.activator=a},g=m=>{m.code===e&&(this.activator===a&&(this.activator=null),d||(b.end?.(),this.updatePointer(),document.removeEventListener("keyup",g)),b.keyUp?.(),this.container.removeEventListener("pointerdown",h),c=!1)};let k=m=>{};const h=(m,p=!1)=>{if(!this.isDrawing&&this.activator===a&&m.buttons&7){if(!p){if(1===m.button&&b.middleButton){b.middleButton(m);
return}if(2===m.button&&b.rightButton){b.rightButton(m);return}}var t=p?0:m.button;b.pointer?.[t]?.hide&&this.container.classList.add("no-pointer_");b.pointer?.[t]?.pointerDown?.(m);b.pointer?.[t]?.pointerMove&&(k=b.pointer[t].pointerMove(m));this.container.setPointerCapture(m.pointerId);this.container.addEventListener("pointermove",k);this.container.addEventListener("pointerup",q=>{l(q,p)},{once:!0});k(m);this.lockPointer();this.activeTool=a;d=!0}},l=(m,p=!1)=>{this.container.removeEventListener("pointermove",
k);k.cancel?.();p=p?0:m.button;b.pointer?.[p]?.hide&&this.container.classList.remove("no-pointer_");b.pointer?.[p]?.pointerUp?.(m);this.updatePointer(m);this.unlockPointer();d=!1;c||b.end?.();this.activeTool=null};this.toolActivators.set(a,m=>{f.bind(this)(m);h(m,!0);g(m)});this.tools[a].stop=m=>{!this.activeTool!==a&&(l(m),g(m))};this.pointerTools||(this.pointerTools=new Map);this.pointerTools.set(a,{keyUp:()=>{const m=new Event("keyup");m.code=e;g(m)},keyDown:()=>{const m=new Event("keydown");m.code=
...
this.getMirroredCoords(a);e=this.getPointAngle(this.symmetryGuideX,this.symmetryGuideY,f,g)}return f=>{const [g,k]=this.getMirroredCoords(f,c);0===b?this.updateSymmetryGuides(Math.max(0,Math.min(this.originalWidth,g)),Math.max(0,Math.min(this.originalHeight,k)),this.symmetryGuideAngle):2===b&&(f=this.getPointAngle(this.symmetryGuideX,this.symmetryGuideY,g,k),this.updateSymmetryGuides(this.symmetryGuideX,this.symmetryGuideY,this.s.symmetryGuidesRotationMode===GPPainter_.SYMMETRY_GUIDES_ROTATION_MODE.DRAGGING?
...
k=2*Math.PI/e;this.isSymmetryGuidesAdjustable&&2===e?this.drawSymmetryGuideReticleRing(d,a,b,7):d.arc(a,b,50*this.density,0,2*Math.PI);for(a=0;a<e;a++){var h=a*k+c;b=f+Math.cos(h)*this.symmetryGuidesRadius;h=g+Math.sin(h)*this.symmetryGuidesRadius;d.moveTo(f,g);d.lineTo(b,h)}break;case GPPainter_.SYMMETRY_MODES.MANDALA:for(e=this.s.symmetryMandalaGuidesCount,f=this.symmetryGuideX*this.density,g=this.symmetryGuideY*this.density,k=2*Math.PI/e,this.isSymmetryGuidesAdjustable&&2===e&&this.drawSymmetryGuideReticleRing(d,
a,b,7),a=0;a<e;a++)h=a*k+c,b=f+Math.cos(h)*this.symmetryGuidesRadius,h=g+Math.sin(h)*this.symmetryGuidesRadius,d.moveTo(f,g),d.lineTo(b,h)}d.stroke()}drawSymmetryGuide(a,b,c,d){if(1E-10>Math.abs(Math.cos(d)))a.moveTo(b,0),a.lineTo(b,a.canvas.height);else{d=Math.tan(d);b=c-d*b;c=a.canvas.width;const e=d*c+b;a.moveTo(0,0*d+b);a.lineTo(c,e)}}drawSymmetryGuideReticleLine(a,b,c,d,e){e/=2;d+=Math.PI/2;const f=b+e*Math.cos(d),g=c+e*Math.sin(d);a.moveTo(b-e*Math.cos(d),c-e*Math.sin(d));a.lineTo(f,g)}drawSymmetryGuideReticleRing(a,
...
(this.gridType+1)%4;const b=this.width;var c=this.height;const d=this.density,e=this.gridCtx;e.clearRect(0,0,b,c);if(0!=a){a=(2==a?48:1==a?24:96)*d;var f=b/2,g=f/a;for(var k=0;k<g;k++){var h=k*a;const l=(0==k%4?.5:.25)*d;e.fillRect(f+h,0,l*d,c);e.fillRect(f-h,0,l*d,c)}c/=2;f=c/a;for(g=0;g<f;g++)k=g*a,h=(0==g%4?.5:.25)*d,e.fillRect(0,c+k,b,h*d),e.fillRect(0,c-k,b,h*d);e.globalAlpha=1;this.grid.isConnected||this.pointer.before(this.grid)}else this.grid.remove()}decreaseOpacity(a){this.setOpacity(Math.max(this.s.minOpacity,
...
this.canvas.width;e.height=this.canvas.height;d=e.getContext("2d");d.drawImage(this.background,0,0,e.width,e.height);d.drawImage(this.lastDraw,0,0,e.width,e.height);d.drawImage(this.canvas,0,0,e.width,e.height)}else d=this.canvasCtx;return this.getFillRects(d,a,b,c,this.canvas.width,this.canvas.height).map((e,f)=>4>f%5?Math.round(e/this.density):e)}getFillRects(b,c,d,e,f,h){let g;var l=(p,t,v)=>{let y=t,D=v;if(!r(t,v,p))return{w:-1,h:-1};for(;r(y+1,D,p);)y++;let G=y;do for(y=t-1,D++;r(y+1,D,p)&&y+1<=G;)y++;while(y==G);p=--D-v;return{x:t,y:v,w:G-t,h:p}},m=(p,
t,v)=>{let y=t,D=v;if(!r(t,v,p))return{w:-1,h:-1};for(;r(y-1,D,p);)y--;let G=y;do for(y=t+1,D--;r(y-1,D,p)&&y-1>=G;)y--;while(y==G);p=v-++D;return{x:G,y:D,w:t-G,h:p}},n=(p,t,v)=>{let y=t,D=v;if(!r(t,v,p))return{w:-1,h:-1};for(;r(y,D+1,p);)D++;let G=D;do for(D=v-1,y--;r(y,D+1,p)&&D+1<=G;)D++;while(D==G);p=t-++y;return{x:y,y:v,w:p,h:G-v}},q=(p,t,v)=>{let y=t,D=v;if(!r(t,v,p))return{w:-1,h:-1};for(;r(y,D-1,p);)D--;let G=D;do for(D=v+1,y++;r(y,D-1,p)&&D-1>=G;)D--;while(D==G);p=--y-t;return{x:t,y:G,w:p,
h:v-G}};let r=(p,t,v)=>{if(g[p][t])return!1;p=4*(p+t*f);p=B.slice(p,p+4);t=Math.abs(v[1]-p[1]);let y=Math.abs(v[2]-p[2]),D=Math.abs(v[3]-p[3]);return 20>Math.abs(v[0]-p[0])&&20>t&&20>y&&20>D||0==p[3]&&255==v[0]&&255==v[1]&&255==v[2]||0==v[3]&&255==p[0]&&255==p[1]&&255==p[2]};var z=p=>{var t=p[0];let v=p[1],y=t+p[2],D=v+p[3];for(;t<y;t++)for(let G=v;G<D;G++)g[t][G]=!0;return p};c=Math.round(c);d=Math.round(d);e=parseInt(e.replace("#","0x"));var x=e%256,w=(e=Math.floor(e/256))%256,E=e=Math.floor(e/
256);(()=>{g=[];for(var p=-1;p<=f;p++)g[p]=[];g[-1]=[];g[f]=[];for(p=-1;p<=h;p++)g[-1][p]=1,g[f][p]=1;for(p=0;p<f;p++)g[p][-1]=1,g[p][h]=1})();let B=b.getImageData(0,0,f,h).data;b=4*(c+d*f);b=[B[b],B[b+1],B[b+2],B[b+3]];e=[];for(let p=0;p<=f;p++)e[p]=[];if(r(c,d,[E,w,x,255]))return[];for(var A;r(c-1,d,b);)c--;for(;r(c,d-1,b);)d--;x=l(b,c,d);w={x:c,y:d,w:x.w,h:x.h,ref:0,andada:0,stack:0};E=x.w;c=[...z([x.x,x.y,x.w+1,x.h+1]),0];do{d=0;for(2==w.ref&&(d+=w.andada);d<=w.h;)-1!=(A=(x=q(b,w.x+w.w+1,w.y+
w.h-d)).h)?(e[A].push({x:x.x,y:x.y,w:x.w,h:x.h,ref:1,andada:w.h+1-d,stack:c.length}),c.push(...z([x.x,x.y,x.w+1,x.h+1]),w.stack),A>E&&(E=A),d+=A):d++;d=0;for(1==w.ref&&(d+=w.andada);d<=w.h;)-1!=(A=(x=n(b,w.x-1,w.y+d)).h)?(e[A].push({x:x.x,y:x.y,w:x.w,h:x.h,ref:2,andada:w.h+1-d,stack:c.length}),c.push(...z([x.x,x.y,x.w+1,x.h+1]),w.stack),A>E&&(E=A),d+=A):d++;d=0;for(4==w.ref&&(d+=w.andada);d<=w.w;)-1!=(A=(x=l(b,w.x+d,w.y+w.h+1)).w)?(e[A].push({x:x.x,y:x.y,w:x.w,h:x.h,ref:3,andada:w.w+1-d,stack:c.length}),
c.push(...z([x.x,x.y,x.w+1,x.h+1]),w.stack),A>E&&(E=A),d+=A):d++;d=0;for(3==w.ref&&(d+=w.andada);d<=w.w;)-1!=(A=(x=m(b,w.x+w.w-d,w.y-1)).w)?(e[A].push({x:x.x,y:x.y,w:x.w,h:x.h,ref:4,andada:w.w+1-d,stack:c.length}),c.push(...z([x.x,x.y,x.w+1,x.h+1]),w.stack),A>E&&(E=A),d+=A):d++;for(w=e[E].pop();null==w&&0<E;)w=e[--E].pop()}while(null!=w);let C=new Map;l=(p,t,v,y,D)=>{if(!g[p][t]){v=p+v;var G=t+y;if(!(0>v||v>=f||0>G||G>=h))for(y=4*(p+t*f),v=4*(v+G*f),G=0;4>G;G++)if(20<=Math.abs(B[y+G]-B[v+G])){y=p*
h+t;C.has(y)||C.set(y,[p,t,D]);break}}};for(m=0;m<c.length;m+=5){n=c[m];q=c[m+1];z=c[m+2];A=c[m+3];if(n+z<f)for(d=q;d<q+A;d++)l(n+z,d,1,0,m);if(0<n)for(d=q;d<q+A;d++)l(n-1,d,-1,0,m);if(q+A<h)for(d=n;d<n+z;d++)l(d,q+A,0,1,m);if(0<q)for(A=n;A<n+z;A++)l(A,q-1,0,-1,m)}for(let [,[p,t,v]]of C)c.push(p,t,1,1,v);return c}setTimer(){this.timer&&
...
c??this.positionY;this.rotation=d??this.rotation;this.updateTransform(e)}applyViewportBounds(a,b){var c=GPZoomer_.MIN_VISIBLE_PADDING,d=this.content.offsetWidth===this.viewport.offsetWidth?this.content:this.content.firstElementChild;if(!(this.rotation%360)||0!==c){const e=this.viewport.offsetWidth,f=this.viewport.offsetHeight,g=d.offsetWidth*this.scale,k=d.offsetHeight*this.scale,h=d.offsetLeft*this.scale;d=d.offsetTop*this.scale;const l=e-c-h,m=c-g-h,p=f-c-d;c=c-k-d;a=Math.min(l,Math.max(m,a));b=
Math.min(p,Math.max(c,b));m>l&&(a=(e-g)/2-h);c>p&&(b=(f-k)/2-d);return[a,b]}return[a,b]}applyTransition(a){this.content.style.transition=this.rotator.style.transition=a?`transform ${GPZoomer_.ANIMATION_DURATION}s ${GPZoomer_.ANIMATION_EASING}`:"none"}updateTransform(a=!0){this.applyTransition(a);this.content.style.transformOrigin="0 0";this.content.style.transform=`translate(${this.positionX}px, ${this.positionY}px) scale(${this.scale})`;this.rotator.style.transform=`rotate(${this.rotation}deg)`}dispatchScale(){this.dispatchEvent(new CustomEvent("scale",
...
background:b,canvasType:c,auth:d,meta:{author:e,title:f,date:g}},container:k,mainContainer:h},l=GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE,m=!1){super();GPTimelapsePlayer_.players.add(this);this.canvasType=c;this.canvasTypeName=GPUtils_.getCanvasTypeName(c);const [p,t]=GPUtils_.getCanvasDimensions(c);this.density=GPTimelapsePlayer_.CANVAS_DENSITY;this.originalWidth=p;this.originalHeight=t;this.width=this.originalWidth*this.density;this.height=this.originalHeight*this.density;this.originalData=a.slice();
const [q,n,u]=this.handleDelimiters(a,b);this.data=q;this.background=n;this.auth=d;this.author=e;this.title=f;this.date=new Date(g);this.eraserAlpha=!u;this.fi=g&&this.date.getTime()>GPTimelapsePlayer_.FV2_DATE?5:4;this.container=k;this.container.isPlayerRendered=!0;this.mainContainer=h;this.defaultDisplayMode=l;this.defaultDisplayModeDensity=this.getModeDensity(l);this.cache;this.canvas;this.ctx;this.isPlaying=!1;this.currentSpeed=JSON.parse(localStorage.getItem("gp-timelapse-player-speed"))||GPTimelapsePlayer_.SPEED;
...
1,a.lastIndexOf("}"))}}window.GPTimelapsePlayer_=GPTimelapsePlayer_;
}).call(this)
