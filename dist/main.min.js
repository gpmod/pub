...
date:a,startBtn:b}}))}isRaidTime(a){return 18<=a.getHours()&&23>=a.getHours()}getMSKDate(){var a=new Date,b=a.getTime();a=b-(new Date(a.toLocaleString("en-US",{timeZone:"Europe/Moscow"}))).getTime();b=new Date(b-a);a=b.toLocaleDateString("en-US");return[b,a]}startGameHandler(a){}isLobbyScreen(a){return"lobby"===a.slice(1)}updateSettings({detail:{settings:a}}){"showRaidAlert"in a&&a.showRaidAlert&&this.gpproxy.isGameStage(GPProxy_.GAME_STAGE.LOBBY)&&this.requestRaidStatus();"personalRaidCheck"in a&&
