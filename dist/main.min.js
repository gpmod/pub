...
"scripts_";var c=document.createElement("div");c.className="title_";c.textContent=this.l.UPDATE_SCRIPTS_TITLE;b.appendChild(c);const d=document.createElement("div");d.className="reload-row_";c=document.createElement("a");c.className="reload-btn_";c.href="/";c.textContent=this.l.RELOAD_BTN_LBL;c.addEventListener("click",g=>{g.preventDefault();window.onbeforeunload=null;location.reload()});c.addEventListener("auxclick",g=>{g.preventDefault()});d.appendChild(c);const e=new Set;Array.from(a.values()).forEach((g,
f)=>{var h=`${g.url}?${Date.now()}.user.js`;const k=document.createElement("div");k.className="oudated-script_";var l=document.createElement("div");l.textContent=g.name;k.appendChild(l);l=document.createElement("div");l.textContent=`${g.version} \u2794 ${g.latestVersion}`;k.appendChild(l);g=document.createElement("div");k.appendChild(g);const m=document.createElement("a");m.className="script-update-link_";m.href=h;m.target="_blank";m.textContent=this.l.UPDATE_SCRIPT_LBL;h=n=>{e.add(f);e.size>=a.size&&
d.classList.add("shown_");m.closest(".oudated-script_").classList.add("clicked_")};m.addEventListener("click",h);m.addEventListener("auxclick",h);g.appendChild(m);b.appendChild(k)});b.appendChild(d);return b}}window.GPAbout_=GPAbout_;class GPActivation_ extends EventTarget{static AUTH_FILENAME_STORAGE="gp_auth-filename";static ACTIVATION_KEY_PATTERN=/^[a-zA-Z0-9]{32}:\d{14,16}$/;static DEFAULT_SETTINGS={activationKey:"",publicKey:"",filename:""};static SETTINGS_UI={activationKey:{type:"input",args:{hidden:!0},description:"\u041a\u043b\u044e\u0447 \u0430\u043a\u0442\u0438\u0432\u0430\u0446\u0438\u0438"}};static MODULE={title:"Activation",settings:{storage:"gp_activation",defaultSettings:this.DEFAULT_SETTINGS,ui:this.SETTINGS_UI}};static INIT(a){a.act=
