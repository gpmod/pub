...
background:b,canvasTypeId:c,auth:d,meta:{author:e,title:f,date:g}},container:k,mainContainer:h},l=GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE,m=!1){super();GPTimelapsePlayer_.players.add(this);this.canvasTypeId=c;this.canvasType=GPUtils_.getCanvasTypeById(c);const [p,t]=GPUtils_.getCanvasDimensionsById(c);this.density=GPTimelapsePlayer_.CANVAS_DENSITY;this.originalWidth=p;this.originalHeight=t;this.width=this.originalWidth*this.density;this.height=this.originalHeight*this.density;this.originalData=a.slice();
