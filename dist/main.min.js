...
summaryURL:"",updateNoticeFlag:!0,updateNoticeText:"",discordURL:"https://discord.gg/xxtCmzt8uA",subscribeURL:"https://boosty.to/gpmod"};if(function(){return navigator?.userAgentData?.brands.some(d=>"Chromium"===d.brand)||navigator.userAgent.toLowerCase().includes("firefox")}()){var c={ws:null,prx:null,ref:null,act:null,av:null,abt:null};document.addEventListener("_ws",({detail:{ws:d,authData:e,l10n:f}})=>{c.prx?c.prx.setWebSocket(d):a(d,e,f);window.ws=d});document.getElementById("__next")?.classList.toggle("gp-ad-not-found_",
